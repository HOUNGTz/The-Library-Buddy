...
```
cd existing_repo
git remote add origin https://gitlab.com/houngtzone/MobileAppDevelopment.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/houngtzone/MobileAppDevelopment/-/settings/integrations)
